...
namespace Spaceworks {
    ...
    public class Perlin : INoise {
        ...
        /// <param name="t">T.</param>
        private static double quinticDerivative(double t) {
        ...
        /// <summary>
        /// Perlin noise value, Range -1.0 : 1.0
        /// </summary>
        ...
        private double Ridge(double x, double offset = 0) {
            x = System.Math.Abs(x);
            x = offset - x;
            x *= x;
            return x;
